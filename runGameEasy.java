/*
 *File name: runGameEasy.java
 *Number of classes: 4
 *Name of other three class: Out.java, Player_Vs_Player.java, Main.java
...
public class runGameEasy {
    //declare screen size variable
    int screenSize;

    //controls tracing statements
    boolean tracing = false;

    //string to store winning letter
    String winningLetter;

    //Create scanner and bufferedreader
    ...
    public runGameEasy(int n) throws Exception {
        screenSize = n;
        ...
        Out.centerWrite("Since this is easy mode you can go first, you will be X", screenSize);
        ...
        do {
            ...
            do{
                ...
                Out.centerWrite("Now the computer will move", screenSize);
    ...
    public void computerMoves(){
        ...
        do{
            n = (int) Math.abs(Math.random()*9+1);
        }while(isOccupied(n));
